...
const GUIDES: Record<string, GuideCategory> = {
  student: {
    ...
    steps: [
      ...
      { emoji: "💻", title: "Lodge through ImmiAccount", summary: "Apply online at immi.homeaffairs.gov.au.", detail: "Create an ImmiAccount and complete the application online. You'll upload your CoE, OSHC certificate, financial evidence, academic transcripts, English test results, and a Genuine Temporary Entrant (GTE) statement explaining your study intentions. Check the current application fee at immi.homeaffairs.gov.au before lodging.", timeframe: "Typically weeks offshore — check current times at immi.homeaffairs.gov.au", cost: "AUD $710" },
    ],
  },
  pr: {
    ...
    steps: [
      { emoji: "📋", title: "Get your skills assessed", summary: "A positive assessment from your relevant authority is required first.", detail: "Every occupation has a designated assessing authority — find yours at immi.homeaffairs.gov.au. Assessment typically takes several weeks and costs vary by authority. Confirm your specific authority and process before applying.", timeframe: "4–12 weeks", cost: "$300–$1,200" },
      ...
      { emoji: "✉️", title: "Receive invitation and lodge visa application", summary: "Once invited, you have 60 days to lodge the full visa application.", detail: "After receiving an invitation, you lodge the full application including all supporting documents, health examinations, police clearances, and skills evidence. A migration agent can ensure everything is correct — errors cause significant delays.", timeframe: "60 days from invitation", cost: "~AUD $4,640 (189/190) — check current fees at immi.homeaffairs.gov.au" },
    ],
  },
  visitor: {
      ...
      <div style={{ maxWidth: 560, margin: "0 auto", paddingTop: "4rem", paddingBottom: "4rem" }}>
        ...
        <div style={{ background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 14, padding: "10px 14px", marginBottom: "1.25rem", display: "flex", alignItems: "flex-start", gap: 8 }}>
          ...
          <p style={{ fontSize: 12, color: "#92400e", lineHeight: 1.6, margin: 0 }}>
            <strong>General information only — not migration advice.</strong> Fees, processing times and rules change frequently. Confirm all details with a{" "}
        ...
        <p style={{ textAlign: "center", fontSize: 12, color: "#94a3b8", marginTop: "1.5rem" }}>
          ✦ General information only — not migration advice. Fees, processing times and eligibility rules change without notice. Always confirm your specific situation with a MARA-registered migration agent or at immi.homeaffairs.gov.au before making any decisions.
        </p>
      </div>
    </main>
  );
