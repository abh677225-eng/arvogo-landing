...
const COMMON_STEPS = [
  ...
  },
  {
    ...
    summary: "Browse listings, attend inspections, and learn how to evaluate what you're looking at.",
    detail: "Use realestate.com.au and domain.com.au to browse listings. Attend as many open homes as you can — even properties you\'re not serious about, just to calibrate your expectations against your budget.\n\nUse homely.com.au for neighbourhood insights. Use onthehouse.com.au to check recent sold prices so you understand what properties actually sell for, not just what they\'re listed at.\n\nA buyers agent is optional but can be valuable if you\'re unfamiliar with the market, time-poor, or planning to bid at auction.\n\n— SHORTLISTING PROPERTIES —\n\nBefore you start, write down your non-negotiables vs nice-to-haves. Non-negotiables are things you genuinely won\'t compromise on (e.g. number of bedrooms, maximum commute time). Nice-to-haves are everything else. This stops you being swayed by a beautiful kitchen in the wrong location.\n\nDrive past a property before booking an inspection. Street presence, noise, parking and neighbourhood feel can rule something out without costing you an hour of your time.\n\nAlways check sold prices before inspecting. If a property is listed at $850k but comparable properties sold for $780k, you have a starting point for negotiation.\n\n— AT THE OPEN HOME —\n\nArrive early and stay late — agents are more forthcoming when fewer people are around. Take notes and photos — properties blur together quickly.\n\nCheck for signs of moisture: staining on ceilings or walls, bubbling or flaking paint, musty smell, soft floorboards. These are the most common and costly issues.\n\nTest water pressure (run a tap), check mobile signal, open every cupboard, look at storage, and assess natural light. Visit at a different time of day if you\'re serious — a north-facing living room looks very different at 10am vs 4pm.\n\nCheck the age of the hot water system, air conditioning and roof — these are expensive to replace.\n\n— QUESTIONS TO ASK THE AGENT —\n\nAgents represent the vendor, not you — but they must answer honestly. Ask:\n\n• Why is the vendor selling?\n• How long has it been on the market? Have previous contracts fallen through?\n• How old is the property? Have there been recent renovations — and were permits obtained?\n• What are the council rates? For apartments: what are body corporate fees and what do they cover?\n• Has the property ever been tenanted?\n• Are there any known defects, neighbour disputes, or planned developments nearby?\n• What is the vendor\'s preferred settlement timeframe?\n\nThe answers — and how the agent answers them — tell you a lot.",
